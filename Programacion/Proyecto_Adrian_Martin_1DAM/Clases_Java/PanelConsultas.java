...
public class PanelConsultas extends JPanel{
    Control control;
    public PanelConsultas(Control control1) {
        control = control1;
        mostrarOpciones();
    }
    ...
    public void mostrarOpciones() {
        ...
        //Label Menú Consultas Datos
        JLabel titulo = new JLabel("Menú Consultar Datos", SwingConstants.CENTER);
        ...
        dni_o_nombre.addActionListener(e -> {
            ...
            if (opcion_dni_o_nombre != null && !opcion_dni_o_nombre.isEmpty()) {
                ...
                if (consulta.hayDatos()) {
                    ...
                    control.frame.setLocationRelativeTo(null);
                    JOptionPane.showMessageDialog(null, "No existen datos con ese DNI/Nombre");
                }
            }
        });
        ...
        por_matricula.addActionListener(e -> {
            ...
            if (opcion_matricula != null && Pattern.matches(mat_valida, opcion_matricula.toUpperCase())) {
                Consultas consulta = new Consultas(control, opcion_matricula, "consultamatricula");
                if (consulta.hayDatos()) {
                    control.frame.setSize(1200, 700);
                    control.frame.setLocationRelativeTo(null);
                } else {
                    control.frame.setSize(400, 300);
                    control.frame.setLocationRelativeTo(null);
                    JOptionPane.showMessageDialog(null, "No existe la matrícula en el sistema");
                }
            } else {
        ...
        gbc.gridy = 2;
        gbc.weightx = 1.0;
        salir.addActionListener(e -> control.cambiarPanel(new PanelPrincipal(control)));
